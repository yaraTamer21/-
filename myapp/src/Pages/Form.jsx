...
const Form = () => {
   ...
   console.log(form)
    ...
    return (
        <>
            <div className="form w-50 m-auto px-5 py-5">
                ...
                <form onSubmit={HandleSubmit} className='my-4'>
                    ...
                    <div>
                        <h3 className='mt-3 text-primary'>المنطقه</h3>

                        <div className='row'>
                            <div className="col-6">
                                <div  className='d-flex align-items-center' style={{ width: "fit-content" }}>
                                    <input  name="region"  onChange={handleData} value="الروضه" type="radio" className='mb-0'  />
                                    <label class="container fs-5 fw-bolder text-primary ">الروضه</label>
                    ...
                    <div className='mt-5'>
                        <h3 className='mt-3 text-primary'>صوره البطاقه المدنيه</h3>
                    ...
                    <div className='my-5'>
                        ...
                        <div >
                            <div className='d-flex  align-items-center'>
                                <div className="parent-images ">
                                    <div style={{ width: "39vw" }} className="child-image ">
                                        <img src='./images/image (1) 2.png' />
                                    </div>
                    ...
                    <div className='d-flex text-primary align-items-center justify-content-between' >
                        <h5>بيانات الابناء المتفوقين و الفائيقات</h5>
